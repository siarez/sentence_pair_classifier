...
class Model():
    def __init__(self, mode):
        ...
        self.a = tf.placeholder(dtype='float', shape=[None, 300], name='ai')
        self.b = tf.placeholder(dtype='float', shape=[None, 300], name='bi')
        ...
        #self.accuracy_op = self.accuracy.assign_add(tf.reduce_sum(tf.cast(tf.equal(self.classes, tf.cast(self.label, tf.int64)), dtype=tf.float32)))
